    ...
    <div>
      <div className="fruit-container">
        ...
        <div>
          ...
          >
            <p style={{ font: "Roboto", fontSize: 15 }}>
              In the North Eastern Region (NER) of India, mango is mainly
              cultivated in subtropical plain / mid hill region of Assam,
              Manipur, Tripura, Mizoram and Meghalaya. Cultivation of mango is
              believed to have originated in South East Asia. Mango is being
              cultivated in southern Asia for nearly six thousand years. .
            </p>
            <p>
              The Mango fruit is very popular due to its wide range of
              ...
              C. The fruit is consumed raw or ripe. Good mango varieties contain
              20% of total soluble sugars.
            </p>

            <p>
              Mango is well adapted to tropical and sub-tropical climates. It
              ...
              itself is not so injurious to mango, but in combination with low
              humidity and high winds, it asects the tree adversely.
            </p>
            <p>
              The North Eastern Region (NER) of India needs a special attention
              for promoting the cultivation of Mango particularly in the area
              suitable for its cultivation and wild varieties may also be
              brought under consideration for further investigation and its
              subsequent use in mango development programme through further
              research.
            </p>
          </div>
        </div>
